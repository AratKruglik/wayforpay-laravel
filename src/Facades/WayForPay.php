 ...
 * @method static string hold(\AratKruglik\WayForPay\Domain\Transaction $transaction, ?string $returnUrl = null, ?string $serviceUrl = null)
 * @method static array getHoldFormData(\AratKruglik\WayForPay\Domain\Transaction $transaction, ?string $returnUrl = null, ?string $serviceUrl = null)
